...
public class ChessProject extends JFrame implements MouseListener, MouseMotionListener {
    ...
    public ChessProject(){
  	...
  	for(int i=8;i < 16; i++){
       		pieces = new JLabel( new ImageIcon("src/WhitePawn.png") );
			panels = (JPanel)chessBoard.getComponent(i);
	        panels.add(pieces);
		}
        pieces = new JLabel( new ImageIcon("src/WhiteRook.png") );
        panels = (JPanel)chessBoard.getComponent(0);
        panels.add(pieces);
        pieces = new JLabel( new ImageIcon("src/WhiteKnight.png") );
        panels = (JPanel)chessBoard.getComponent(1);
        panels.add(pieces);
        pieces = new JLabel( new ImageIcon("src/WhiteKnight.png") );
        panels = (JPanel)chessBoard.getComponent(6);
        panels.add(pieces);
        pieces = new JLabel( new ImageIcon("src/WhiteBishop.png") );
        panels = (JPanel)chessBoard.getComponent(2);
        panels.add(pieces);
        pieces = new JLabel( new ImageIcon("src/WhiteBishop.png") );
        panels = (JPanel)chessBoard.getComponent(5);
        panels.add(pieces);
        pieces = new JLabel( new ImageIcon("src/WhiteKing.png") );
        panels = (JPanel)chessBoard.getComponent(3);
        panels.add(pieces);
        pieces = new JLabel( new ImageIcon("src/WhiteQueen.png") );
        ...
        panels.add(pieces);
        for(int i=48;i < 56; i++){
            pieces = new JLabel( new ImageIcon("src/BlackPawn.png") );
            panels = (JPanel)chessBoard.getComponent(i);
            panels.add(pieces);
        }
        pieces = new JLabel( new ImageIcon("src/BlackRook.png") );
        panels = (JPanel)chessBoard.getComponent(56);
        panels.add(pieces);
        pieces = new JLabel( new ImageIcon("src/BlackKnight.png") );
        panels = (JPanel)chessBoard.getComponent(57);
        panels.add(pieces);
        pieces = new JLabel( new ImageIcon("src/BlackKnight.png") );
        panels = (JPanel)chessBoard.getComponent(62);
        panels.add(pieces);
        pieces = new JLabel( new ImageIcon("src/BlackBishop.png") );
        panels = (JPanel)chessBoard.getComponent(58);
        panels.add(pieces);
        pieces = new JLabel( new ImageIcon("src/BlackBishop.png") );
        panels = (JPanel)chessBoard.getComponent(61);
        panels.add(pieces);
        pieces = new JLabel( new ImageIcon("src/BlackKing.png") );
        panels = (JPanel)chessBoard.getComponent(59);
        panels.add(pieces);
        pieces = new JLabel( new ImageIcon("src/BlackQueen.png") );
    ...
    */
    private Stack getWhitePawnSquares(int x, int y, String piece){
        ...
        Square tmp = new Square(x, y+1, piece);
        Square tmp2 = new Square(x, y+2, piece);
        Move validM, validM2;
        ...
        if(startingSquare.getYC() == 1){
            ...
            if(!piecePresent(((tmp3.getXC()*75)+20), (((tmp3.getYC()*75)+20)))){
                Move startingMove1 = new Move(startingSquare, tmp);
                moves.push(startingMove1);
            }

            if(!piecePresent(((tmp2.getXC()*75)+20), (((tmp2.getYC()*75)+20)))){
                Move startingMove2 = new Move(startingSquare, tmp2);
                moves.push(startingMove2);
            }

            //attacking piece at SW diagonal
            int tmpxL = x-1;
            int tmpyL = y+1;
            if(!(tmpxL > 7 || tmpxL < 0 || tmpyL > 7 || tmpyL < 0)){
                Square tmpLMov = new Square(tmpxL, tmpyL, piece);
                validM = new Move(startingSquare, tmpLMov);
                if(piecePresent(((tmpLMov.getXC()*75)+20), (((tmpLMov.getYC()*75)+20)))){
                    if(checkWhiteOponent(((tmpLMov.getXC()*75)+20), ((tmpLMov.getYC()*75)+20))){
                        moves.push(validM);
                    }
                }
            }

            //attacking piece at SE diagonal
            int tmpxR = x+1;
            int tmpyR = y+1;
            if(!(tmpxR > 7 || tmpxR < 0 || tmpyR > 7 || tmpyR < 0)){
                Square tmpRMov = new Square(tmpxR, tmpyR, piece);
                validM2 = new Move(startingSquare, tmpRMov);
                if(piecePresent(((tmpRMov.getXC()*75)+20), (((tmpRMov.getYC()*75)+20)))){
                    if(checkWhiteOponent(((tmpRMov.getXC()*75)+20), ((tmpRMov.getYC()*75)+20))){
                        moves.push(validM2);
                    }
                }
            }
            ...
            Move validMove1 = new Move(startingSquare, tmp3);
            if(!piecePresent(((tmp3.getXC()*75)+20), (((tmp3.getYC()*75)+20)))){
...
*/
  ...
  */
        ...
        }//end of the loop with x doing nothing and Y increasing...
        for(int l=1;l < 8;l++){
            int tmpx4 = x;
            int tmpy4 = y-l;
            if(!(tmpy4 > 7 || tmpy4 < 0)){
        ...
        }//end of the loop with x doing nothing and Y decreasing...
        return moves;
...
*/
    ...
    */
            ...
            //Didn't have time to configure Option dialog to choose opponent. Just comment out
            //which AI component to use for game
            ...
            /*
                ...
                else if(AIOpponent == 1){
                    Move selectedMove = agent.randomMove(testing);
                }
                else if(AIOpponent == 2){
                    Move selectedMove = agent.randomMove(testing);
                }
            */
   ...
   */
        ...
        */
        ...
        if(possible){
          ...
          */
            ...
            else if(pieceName.contains("src/BlackPawn")){
    ...
    */
    ...
    public static void setUpGame(){
        ...
        //invoke statement which would determine what ai component is playing
        if(n == 0){
            //use random player
        }
        else if(n == 1){
